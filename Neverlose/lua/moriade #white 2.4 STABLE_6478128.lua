...
menu = {
    anti_aim = {
        ...
        visuals = {
            ...
            grenade_fix = tabs.anti_aim.visuals:switch("\v\f<crosshairs>\r  Grenade Throw Fix"),
        },
        tweaks = {
            ...
            fs_flick = tabs.anti_aim.tweaks:switch("\v\f<rotate-exclamation>\r   Flick opposite on FS"),
        ...
        private = {
            ...
            widgets = tabs.anti_aim.colors:switch("\v\f<window>\r  Widgets"),
        },
        config = {
...
local cfg_data = {
    ints = {
        ...
        menu.anti_aim.visuals.grenade_fix,
...
set_visibility = function()
    ...
    menu.anti_aim.visuals.trash_talk:visibility(menu.anti_aim.tab_switch.tab_switcher:get() == 4)
    ...
    menu.anti_aim.visuals.auto_teleport:visibility(menu.anti_aim.tab_switch.tab_switcher:get() == 3 and menu.anti_aim.tab_switch_misc.tab_switch_misc_2:get() == 2)
    ...
    menu.anti_aim.visuals.grenade_fix:visibility(menu.anti_aim.tab_switch.tab_switcher:get() == 4)
...
--
--grenade_fix
local function grenade_fix()
if menu.anti_aim.visuals.grenade_fix:get() then
...
local function fs_flick()
    if menu.anti_aim.tweaks.fs_flick:get() then
        if aa_refs.freestanding:get() or menu.anti_aim.condition.conditions.fs_aa:get() then
            refs.findik:override("Always on")
            aa_refs.hidden_yaw:set(true)
            aa_refs.yaw_offset:set(0)
            aa_refs.yaw_modifier:override("Disabled")
